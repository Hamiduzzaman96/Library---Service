...
type BookServiceClient interface {
	...
	UpdateBook(ctx context.Context, in *UpdateBookRequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *bookServiceClient) UpdateBook(ctx context.Context, in *UpdateBookRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type BookServiceServer interface {
	...
	UpdateBook(context.Context, *UpdateBookRequest) (*Empty, error)
...
func (UnimplementedBookServiceServer) UpdateBook(context.Context, *UpdateBookRequest) (*Empty, error) {
